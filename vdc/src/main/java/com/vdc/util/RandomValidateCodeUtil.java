...
public class RandomValidateCodeUtil {
	...
	public RandomValidateCodeUtil(int width, int height, int lineSize, int stringNum) {
		this.width = width;// 图片宽
		this.height = height;// 图片高
		this.lineSize = lineSize;// 干扰线数量
		this.stringNum = stringNum;// 随机产生字符数量
	}
