...
(function($) {
	...
	$.message = function() {
		...
		if (msg.type == null || msg.content == null) {
			return false;
		}
		
		if ($message == null) {
			$message = $('<div class="xxMessage"><div class="messageContent message' + msg.type + 'Icon"><\/div><\/div>');
		...
		$message.children("div").removeClass("messagewarnIcon messageerrorIcon messagesuccessIcon").addClass("message" + msg.type + "Icon").html(message(msg.content));
