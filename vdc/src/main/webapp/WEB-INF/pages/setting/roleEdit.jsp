...
<body>
	...
	<c:set var="actionUrl" value="${ctx}/setting/role/save"/>
	<c:if test="${not empty roleId}">
	<c:set var="actionUrl" value="${ctx}/setting/role/update/${roleId}"/>
	</c:if>
		...
		<table class="input">
			<tr>
				...
				<td>
					...
					<input type="button" class="button" value="返&nbsp;&nbsp;回" onclick="location.href='${ctx}/setting/role/list'" />
				</td>
			</tr>
		</table>
	</form>
