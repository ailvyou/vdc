...
<body>
	...
	<c:set var="actionUrl" value="${ctx}/system/user/save"/>
	<c:if test="${not empty userId}">
	<c:set var="actionUrl" value="${ctx}/system/user/update/${userId}"/>
	</c:if>
		...
		<table class="input">
			<tr>
				...
				<td>
					...
					<input type="button" class="button" value="返&nbsp;&nbsp;回" onclick="location.href='${ctx}/system/user/list'" />
				</td>
			</tr>
		</table>
	</form>
