...
<body>
	...
	<form id="listForm" action="${ctx}/system/role/list" method="get">
		<div class="bar">
			<a href="${ctx}/system/role/create" class="iconButton">
				<span class="addIcon">&nbsp;</span>添加
			</a>
			<div class="buttonWrap">
				<a href="javascript:;" id="deleteButton" class="iconButton disabled" actionUrl="${ctx}/system/role/delete">
