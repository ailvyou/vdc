...
<body>
	...
	<form id="listForm" action="${ctx}/system/user/list" method="get">
		<div class="bar">
			<a href="${ctx}/system/user/create" class="iconButton">
				<span class="addIcon">&nbsp;</span>添加
			</a>
			<div class="buttonWrap">
				<a href="javascript:;" id="deleteButton" class="iconButton disabled" actionUrl="${ctx}/system/user/delete">
		...
		<table id="listTable" class="list">
			...
			<c:forEach items="${pagination.data}" var="item">
				<tr>
					...
					<td>
						<a href="${ctx}/system/user/edit/${item.userId}">[编辑]</a>
					</td>
				</tr>
			</c:forEach>
		</table>
